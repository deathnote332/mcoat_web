...
class ReceiptController extends Controller
{
    ...
    public function invoice(Request $request){
        ...
        $products = DB::table('product_out_items')
                            ->join('tblproducts','tblproducts.id','product_out_items.product_id')
                            ->select('tblproducts.*','product_out_items.quantity as product_qty','product_out_items.unit_price as p_items_price')
                            ->where('receipt_no',$request->id)
