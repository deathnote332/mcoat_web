...
<head>
    ...
    <title>ATILANO'S CAFE</title>

    <!-- Fonts -->
    <link href="https://fonts.googleapis.com/css?family=Raleway:100,600" rel="stylesheet" type="text/css">
    <link rel="stylesheet" href="{{url('vendor/bootstrap/3.3.7/bootstrap.min.css')}}">
    ...
    <script src="{{url('home/custom.js')}}"></script>
    <script src="{{url('home/easing.min.js')}}"></script>
    <script src="{{url('home/morphext.min.js')}}"></script>
    <script src="{{url('home/animate.min.css')}}"></script>
    <script src="{{url('home/hoverIntent.js')}}"></script>
    <script src="{{url('home/sticky.js')}}"></script>
    <script src="{{url('home/superfish.min.js')}}"></script>
    <script src="{{url('home/wow.min.js')}}"></script>
</head>
<body>
