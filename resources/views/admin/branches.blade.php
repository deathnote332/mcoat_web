    ...
    <section id="content">
        ...
        <div class="nav-tabs-custom">
            <ul class="nav nav-tabs">
                <li class="active"><a href="#tab_1" data-toggle="tab">BRANCH LIST</a></li>
            </ul>
                    ...
                    <div class="form-group">
                        ...
                        <div class=" col-md-4 col-md-offset-2 no-padding-right ">
                            <div class="btn-add margin no-padding-right ">
                                <button type="button" class="btn btn-primary form-control add-new"> Add new branch</button>
                            </div>
